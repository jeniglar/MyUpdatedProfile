            ...
            <Container className="py-5">
                ...
                <section class="col-md-8">
                    <section class="card mb-3 px-3">
                        <h1 class="about text-primary">About Me</h1>
                        ...
                        <a class= "about" href="./Assets/JenIglar.pdf">Resume</a>
                        <br></br>
                        <a class= "about" href="https://linkedin.com/in/jen-iglar-76356aa">Let's connect on LinkedIn!</a>
                        <br></br>
                        <a class= "about" href="https://github.com/jeniglar">Check out my GitHub Portfolio</a>
                        <br></br>
                        <p class= "about">Email: jeniglar@gmail.com</p>
                        <p class= "about">Phone: 908-310-9259</p>
                        </section>
                    </section>
